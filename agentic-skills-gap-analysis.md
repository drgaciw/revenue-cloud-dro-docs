---
title: "Agentic Skills Gap Analysis"
description: "Decide which RCA/DRO skills to adopt, adapt, or build based on verified interfaces and project-specific gaps."
...
related: ["agentic-skills-inventory", "external-agentic-skills", "rlm-skills-porting", "wrapper-patterns"]
...
Analyze missing capabilities without treating third-party repositories as Salesforce authority.
...
| Capability | Disposition | Priority | Reason |
|---|---|---|---|
| Salesforce platform authoring/testing | Adopt `forcedotcom/sf-skills` | Foundation | Official, broad platform coverage |
| DRO object/schema grounding | Adopt official docs; optionally adapt a reviewed third-party reference | P0 | Required by every other skill |
| Decomposition validation | Build custom | P0 | Must encode project entitlement fixtures and deterministic diffs |
| Fulfillment graph review | Build custom | P0 | Requires project failure and approval policy |
| Entitlement audit | Build custom | P1 | Crosses custom middleware, tokens, and audit ledger |
| OCI label synchronization | Build custom | P1 | Registry conventions are project-specific |
| Wrapper authoring | Build custom over official Apex/MCP patterns | P2 | Needed only for verified interface gaps |
