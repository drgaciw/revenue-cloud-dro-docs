...
- [rlm-skills-porting.md](rlm-skills-porting.md) — Assessment of porting RLM Cursor skills (bgaldino/rlm-base-dev) to Claude Code SKILL.md format: feasibility, selective port plan, effort, risks. **Keywords:** porting, RLM skills, Cursor to Claude, skill-port, SKILL.md, schema grounding, selective port.
